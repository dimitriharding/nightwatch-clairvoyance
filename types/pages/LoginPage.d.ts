// [LOGINPAGE DEFINITIONS START]}

// Type definitions for LoginPage
// Auto Generated By Nightwatch Clairvoyance
// Definitions by: Dimitri Harding <https://github.com/dimitriharding>
// TypeScript Version: 2.3

import {Expect,NightwatchCallbackResult, NightwatchAPI, SharedCommands, NightwatchAssertionsError } from 'nightwatch';
import {UserDefinedPageObject} from '../index';

export type UserDefinedLoginPageObject = () => LoginPage;

export type LoginPageSelector = "@txtUsername" | "@txtPassword" | "@btnSubmit" | "@txtNotification";

export interface LoginPage extends UserDefinedPageObject, LoginPageElementCommands, LoginPageCommonAssertions {

    assert: LoginPageCommonAssertions;
    expect: Expect;
    verify: LoginPageCommonAssertions;
   ...
   */
	enterUsername(username, callback?: () => void): this;   

   /** 	
   * Enters the password	
   * @param {string} password 	
   */
	enterPassword(password, callback?: () => void): this;
}
export interface LoginPageElementCommands {
    /**
     ...
     * @see elementIdClear
     */
    clearValue(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     * @see elementIdClick
     */
    click(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     */
    getAttribute(selector: string & LoginPageSelector , attribute: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string | null>) => void): this;
     ...
     */
    getCssProperty(selector: string & LoginPageSelector, cssProperty: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdSize
     */
    getElementSize(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ width: number; height: number }>) => void): this;
     ...
     */
    getLocation(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     */
    getLocationInView(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     * @see elementIdName
     */
    getTagName(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdText
     */
    getText(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdValue
     */
    getValue(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     */
    isVisible(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<boolean>) => void): this;
     ...
     * @see moveTo
     */
    moveToElement(selector: string & LoginPageSelector, xoffset: number, yoffset: number, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @see elementIdValue
     */
    setValue(selector: string & LoginPageSelector, inputValue: string | string[], callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
    /**
     * Alias for `setValue`.
     * @see setValue
     */
     ...
     * @see submit
     */
    submitForm(selector: string & LoginPageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @since v0.4.0
     */
    waitForElementNotPresent(selector: string & LoginPageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     */
    waitForElementNotVisible(selector: string & LoginPageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementPresent(selector: string & LoginPageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementVisible(selector: string & LoginPageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
}

export interface LoginPageCommonAssertions {
    /**
     ...
     * ```
     */
    attributeContains(selector: string & LoginPageSelector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    attributeEquals(selector: string & LoginPageSelector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    containsText(selector: string & LoginPageSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    cssClassPresent(selector: string & LoginPageSelector, className: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    cssClassNotPresent(selector: string & LoginPageSelector, className: string, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    cssProperty(selector: string & LoginPageSelector, cssProperty: string, expected: string | number, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    elementPresent(selector: string & LoginPageSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    elementNotPresent(selector: string & LoginPageSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    hidden(selector: string & LoginPageSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    value(selector: string & LoginPageSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    valueContains(selector: string & LoginPageSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    visible(selector: string & LoginPageSelector, message?: string): NightwatchAPI;

    NightwatchAssertionsError: NightwatchAssertionsError;
}
// [LOGINPAGE DEFINITIONS END]}
