...
export type UserDefinedpageObject = () => page;

export type pageSelector = "@mySubmitButton" | "@myTextInput";

export interface page extends UserDefinedPageObject, pageElementCommands, pageCommonAssertions {

    assert: pageCommonAssertions;
    expect: Expect;
    verify: pageCommonAssertions;
...
export interface pageElementCommands {
    /**
     ...
     * @see elementIdClear
     */
    clearValue(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     * @see elementIdClick
     */
    click(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     */
    getAttribute(selector: string & pageSelector , attribute: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string | null>) => void): this;
     ...
     */
    getCssProperty(selector: string & pageSelector, cssProperty: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdSize
     */
    getElementSize(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ width: number; height: number }>) => void): this;
     ...
     */
    getLocation(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     */
    getLocationInView(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     * @see elementIdName
     */
    getTagName(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdText
     */
    getText(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdValue
     */
    getValue(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     */
    isVisible(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<boolean>) => void): this;
     ...
     * @see moveTo
     */
    moveToElement(selector: string & pageSelector, xoffset: number, yoffset: number, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @see elementIdValue
     */
    setValue(selector: string & pageSelector, inputValue: string | string[], callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
    /**
     * Alias for `setValue`.
     * @see setValue
     */
     ...
     * @see submit
     */
    submitForm(selector: string & pageSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @since v0.4.0
     */
    waitForElementNotPresent(selector: string & pageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     */
    waitForElementNotVisible(selector: string & pageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementPresent(selector: string & pageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementVisible(selector: string & pageSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
}

export interface pageCommonAssertions {
    /**
     ...
     * ```
     */
    attributeContains(selector: string & pageSelector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    attributeEquals(selector: string & pageSelector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    containsText(selector: string & pageSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    cssClassPresent(selector: string & pageSelector, className: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    cssClassNotPresent(selector: string & pageSelector, className: string, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    cssProperty(selector: string & pageSelector, cssProperty: string, expected: string | number, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    elementPresent(selector: string & pageSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    elementNotPresent(selector: string & pageSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    hidden(selector: string & pageSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    value(selector: string & pageSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    valueContains(selector: string & pageSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    visible(selector: string & pageSelector, message?: string): NightwatchAPI;
