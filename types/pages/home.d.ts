...
// [HOME DEFINITIONS START]}
// Type definitions for home
// Auto Generated By Nightwatch Clairvoyance
// Definitions by: Dimitri Harding <https://github.com/dimitriharding>
// TypeScript Version: 2.3

export type UserDefinedhomeObject = () => home;

export type homeSelector = "@searchBar" | "@submitButton";

export interface home extends UserDefinedPageObject, homeElementCommands, homeCommonAssertions {

    assert: homeCommonAssertions;
    expect: Expect;
    verify: homeCommonAssertions;
...
export interface homeElementCommands {
    /**
     ...
     * @see elementIdClear
     */
    clearValue(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     * @see elementIdClick
     */
    click(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     */
    getAttribute(selector: string & homeSelector , attribute: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string | null>) => void): this;
     ...
     */
    getCssProperty(selector: string & homeSelector, cssProperty: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdSize
     */
    getElementSize(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ width: number; height: number }>) => void): this;
     ...
     */
    getLocation(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     */
    getLocationInView(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     * @see elementIdName
     */
    getTagName(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdText
     */
    getText(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdValue
     */
    getValue(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     */
    isVisible(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<boolean>) => void): this;
     ...
     * @see moveTo
     */
    moveToElement(selector: string & homeSelector, xoffset: number, yoffset: number, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @see elementIdValue
     */
    setValue(selector: string & homeSelector, inputValue: string | string[], callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
    /**
     * Alias for `setValue`.
     * @see setValue
     */
     ...
     * @see submit
     */
    submitForm(selector: string & homeSelector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @since v0.4.0
     */
    waitForElementNotPresent(selector: string & homeSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     */
    waitForElementNotVisible(selector: string & homeSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementPresent(selector: string & homeSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementVisible(selector: string & homeSelector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
}

export interface homeCommonAssertions {
    /**
     ...
     * ```
     */
    attributeContains(selector: string & homeSelector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    attributeEquals(selector: string & homeSelector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    containsText(selector: string & homeSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    cssClassPresent(selector: string & homeSelector, className: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    cssClassNotPresent(selector: string & homeSelector, className: string, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    cssProperty(selector: string & homeSelector, cssProperty: string, expected: string | number, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    elementPresent(selector: string & homeSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    elementNotPresent(selector: string & homeSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    hidden(selector: string & homeSelector, msg?: string): NightwatchAPI;
     ...
     * ```
     */
    value(selector: string & homeSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    valueContains(selector: string & homeSelector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * ```
     */
    visible(selector: string & homeSelector, message?: string): NightwatchAPI;

    NightwatchAssertionsError: NightwatchAssertionsError;
}
// [HOME DEFINITIONS END]}
