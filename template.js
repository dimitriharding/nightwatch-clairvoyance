    ...
    commandsAndComments: [
        {
            ...
            code: 'enterUsername(username)'
        },
        {
            rawComment: '\/** \t\n   * Enters the password\t\n   * @param {string} password \t\n   *\/',
            code: 'enterPassword(password)'
        }
    ],
    selectors: [
        '"@txtUsername"',
...
const template = (pageObjectDetails) => {
return`
// [${pageObjectDetails.name.toUpperCase()} DEFINITIONS START]}
// Type definitions for ${pageObjectDetails.name}
// Auto Generated By Nightwatch Clairvoyance
// Definitions by: Dimitri Harding <https://github.com/dimitriharding>
// TypeScript Version: 2.3

export type UserDefined${pageObjectDetails.name}Object = () => ${pageObjectDetails.name};

export type ${pageObjectDetails.name}Selector = ${pageObjectDetails.selectors.join(' | ')};

export interface ${pageObjectDetails.name} extends UserDefinedPageObject, ${pageObjectDetails.name}ElementCommands, ${pageObjectDetails.name}CommonAssertions {

    assert: ${pageObjectDetails.name}CommonAssertions;
    expect: Expect;
    verify: ${pageObjectDetails.name}CommonAssertions;
    ...
    ${pageObjectDetails.commandsAndComments.map(data => data.rawComment + '\n\t' + data.code.replace(')', ", callback?: () => void): this;")).join('   \n\n   ')}
}
export interface ${pageObjectDetails.name}ElementCommands {
    /**
     ...
     * @see elementIdClear
     */
    clearValue(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     * @see elementIdClick
     */
    click(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<null>) => void): this;
     ...
     */
    getAttribute(selector: string & ${pageObjectDetails.name}Selector , attribute: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string | null>) => void): this;
     ...
     */
    getCssProperty(selector: string & ${pageObjectDetails.name}Selector, cssProperty: string, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdSize
     */
    getElementSize(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ width: number; height: number }>) => void): this;
     ...
     */
    getLocation(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     */
    getLocationInView(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<{ x: number; y: number }>) => void): this;
     ...
     * @see elementIdName
     */
    getTagName(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdText
     */
    getText(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     * @see elementIdValue
     */
    getValue(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<string>) => void): this;
     ...
     */
    isVisible(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<boolean>) => void): this;
     ...
     * @see moveTo
     */
    moveToElement(selector: string & ${pageObjectDetails.name}Selector, xoffset: number, yoffset: number, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @see elementIdValue
     */
    setValue(selector: string & ${pageObjectDetails.name}Selector, inputValue: string | string[], callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
    /**
     * Alias for \`setValue\`.
     * @see setValue
     */
     ...
     * @see submit
     */
    submitForm(selector: string & ${pageObjectDetails.name}Selector, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void): this;
     ...
     * @since v0.4.0
     */
    waitForElementNotPresent(selector: string & ${pageObjectDetails.name}Selector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     */
    waitForElementNotVisible(selector: string & ${pageObjectDetails.name}Selector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementPresent(selector: string & ${pageObjectDetails.name}Selector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
     ...
     * };
     */
    waitForElementVisible(selector: string & ${pageObjectDetails.name}Selector, time?: number, abortOnFailure?: boolean, callback?: (this: NightwatchAPI, result: NightwatchCallbackResult<void>) => void, message?: string): this;
}

export interface ${pageObjectDetails.name}CommonAssertions {
    /**
     ...
     * \`\`\`
     */
    attributeContains(selector: string & ${pageObjectDetails.name}Selector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    attributeEquals(selector: string & ${pageObjectDetails.name}Selector, attribute: string, expected: string, message?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    containsText(selector: string & ${pageObjectDetails.name}Selector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    cssClassPresent(selector: string & ${pageObjectDetails.name}Selector, className: string, message?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    cssClassNotPresent(selector: string & ${pageObjectDetails.name}Selector, className: string, msg?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    cssProperty(selector: string & ${pageObjectDetails.name}Selector, cssProperty: string, expected: string | number, msg?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    elementPresent(selector: string & ${pageObjectDetails.name}Selector, msg?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    elementNotPresent(selector: string & ${pageObjectDetails.name}Selector, msg?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    hidden(selector: string & ${pageObjectDetails.name}Selector, msg?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    value(selector: string & ${pageObjectDetails.name}Selector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    valueContains(selector: string & ${pageObjectDetails.name}Selector, expectedText: string, message?: string): NightwatchAPI;
     ...
     * \`\`\`
     */
    visible(selector: string & ${pageObjectDetails.name}Selector, message?: string): NightwatchAPI;

    NightwatchAssertionsError: NightwatchAssertionsError;
}
// [${pageObjectDetails.name.toUpperCase()} DEFINITIONS END]}
`
}

fs.writeFileSync(`./nightwatch-clairvoyance/${sampleData.name}.d.ts`,template(sampleData))
